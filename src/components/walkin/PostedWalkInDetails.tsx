...
const PostedWalkInDetails: React.FC<PostedWalkInDetailsProps> = ({
  ...
  if (isLoading) {
    return <main className="main-section"><Loader text="Loading walkin details"/></main>;
  }

  if (!data) {
    return <main className="main-section"><NotFound text="Oops!, looks like walkin details are not present"/></main>;
  }
  if (isError) {
    return <main className="main-section"><NotFound text="Something went wrong while accessing walkin details. Please try again"/></main>;
  }
